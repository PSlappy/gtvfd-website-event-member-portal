  ...
  return (
    <JumbotronCrawl>
      <div className="flex min-h-full flex-col items-center gap-6 px-4 py-10 sm:px-8">
        ...
        {/* Chase Ring's ::before extends outside the element's own
            bounds, so it needs a wrapper without overflow clipping —
            the table's own horizontal-scroll container is nested
            inside instead of carrying the ring itself. */}
        <div className="gt-chase-ring relative w-full max-w-2xl rounded-lg [animation-delay:160ms]">
          <div className="gt-display-in gt-led-border-gold gt-depth-panel w-full overflow-x-auto rounded-lg border-2 border-gt-gold">
