...
export const fieldClass =
  "gt-depth-recessed w-full rounded border-2 border-gt-gold/50 bg-black/60 px-3 py-2 text-sm text-white placeholder:text-zinc-600 focus:border-gt-gold focus:outline-none focus:ring-1 focus:ring-gt-gold";
